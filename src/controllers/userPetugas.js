...
const userPetugasControllers = {
    registerUser: async (req, res) => {
        ...
        create(data)
            .then((result) => {
                commonHelper.response(res, result.rows, 200, 'username is created')
            })
            .catch((err) => {
                console.log(err)
            })
...
module.exports = userPetugasControllers